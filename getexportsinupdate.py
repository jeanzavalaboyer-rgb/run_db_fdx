...
def get_sheets_service():
    ...
    if not raw_json:
        raise Exception(
            "La variable de entorno GOOGLE_SERVICE_ACCOUNT_JSON no existe o está vacía."
        )
    ...
    try:
        ...
        raise Exception(
            f"GOOGLE_SERVICE_ACCOUNT_JSON no contiene un JSON válido: {e}"
        )
